 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "previous_profit_loss = None  # Profit/Loss value of the previous month for the average_profit_change calculation\n",
    "average_profit_change = None  # average of the changes in Profit/Losses over the entire period\n",
    "dates = [] # empty list to store the dates\n",
    "profit_loss_changes = []  # empty list to store changes in Profit/Losses\n",
    "greatest_profit_increase = None  # greatest increase in profits (amount) over the entire period\n",
    "greatest_profit_increase_date = None  # greatest increase in profits (date) over the entire period\n",
    "greatest_profit_decrease = None  # greatest decrease in profits (amount) over the entire period\n",
    "greatest_profit_decrease_date = None  # greatest decrease in profits (date) over the entire period\n",
    "\n",
    "# Prepare data\n",
    ...
    "        Date = row[0] # grab dates from column A\n",
    "        dates.append(Date)  # Add the date to the dates list\n",
    "        profit_loss = int(row[1])  # convert profit/loss values from column B to integers\n",
    ...
    "    output_file.write(f\"Average Change: ${average_profit_change:.2f}\\n\")\n",
